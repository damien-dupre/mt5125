...
# 1. Model Representation in the Method Section of Academic Reports
...
- Hypotheses using the same Outcome variable should be included in the same model
