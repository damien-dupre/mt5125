...
# medias -----------------------------------------------------------------------
media_path <- file.path(dirname(dirname(here())), "Media", "lectures")
```
...
```{r}
#include_graphics(file.path(media_path, "persona_sinead.png"))

include_graphics("/Users/damienhome/OneDrive/Media/lectures/persona_sinead.png")
```
