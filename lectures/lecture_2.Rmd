...
Imagine a the Outcome Variable is a birthday cake, the full cake represent the variable's variability. Now, imagine each predictor is a guest:

- If there is only one guest eating all the cake, then the predictor explains all the variability of the outcome variable. However it never happens, when there is one guest, there is always some cake remaining or variability unexplained.
- If there is more than one guest, they will take their slices of the cake which can be small or big. Each predictor will explains more or less variability of the outcome. However, the more guest there is, the smaller the slices are.
...
> Occupational EL requirements will be positively related to job satisfaction

Job Satisfaction increases when Occupational Emotional Labor increases

> Surface acting will be negatively related to job satisfaction.

Job Satisfaction decreases when Surface Acting increases

> The negative association between surface acting and job satisfaction will be moderated by occupational EL requirements such that the relationship will be stronger for employees who work in occupations with higher EL requirements.

The effect Surface Acting on Job Satisfaction is higher for high Occupational Emotional Labor than for low Occupational Emotional Labor
...
> Example: **Job satisfaction** of **EU employees** is *higher* than **job satisfaction** of **Non-EU employees**
...
> Example: **Job satisfaction** of at least one of the **company's departments** is *higher* than the other **company's departments**
...
The work motivation of female employees is higher than the work motivation of male employees

The effect of gender on work motivation is higher for Irish employees than French employees

The effect of origin on work motivation is higher for female employees than male employees

Job satisfaction decreases when stress increases

The effect of stress on job satisfaction is higher for Millennials than for Baby boomers

The effect of stress on job satisfaction is higher for less experienced employees than for more experienced employees
