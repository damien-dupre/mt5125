...
Every hypothesis has to state relationship between variables 

- Called $H_a$ (for alternative hypothesis) or $H_1$
- Has a null hypothesis counterpart (no relationship between variables) called $H_0$ (pronounce H naught or H zero)
...
- **Exam results** *increase* when students’ **sleep time** increases
...
- **Exam results** of students **who eat breakfast** will be *higher* than **exam results** of students **who do not eat breakfast** 
...
- **Driving errors** of **motorists who do not talk on the phone while driving** will be *lower* than **driving errors** of **motorists who do not talk on the phone while driving**
