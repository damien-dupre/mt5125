...
subtitle: "Workshop 2: Introduction to Statistics for Business Leaders"
author: "Damien Dupré"
...
Hypothesis: the effect of grades on happiness is mediated by self-esteem
...
- Student satisfaction increases when Online Learning Self-Efficacy (OLSE) increases
- Student satisfaction increases when Learner–Content Interaction (LCI) increases
- Student satisfaction increases when Learner–Instructor Interaction (LII) increases
- Student satisfaction increases when Learner-Learner Interaction (LLI) increases

Model 2
- Perceived learning increases when Online Learning Self-Efficacy (OLSE) increases
- Perceived learning increases when Learner–Content Interaction (LCI) increases
- Perceived learning increases when Learner–Instructor Interaction (LII) increases
- Perceived learning increases when Learner-Learner Interaction (LLI) increases
...
- Uses the letter $\beta$ without statistical tests
...
# Equations and Variable Types

Except in special cases, an Outcome (or Dependent Variable) has to be Continuous
...
In this equation Salary is continuous with a main effect, Origin is categorical with a main effect and Salary with Origin have an interaction effect
